...
export async function registerUnitWithLocation(
    ...
    // Collector will be assigned when they scan the QR code
    const result = await prisma.$transaction(async (tx: any) => {
        ...
        // Create Unit (NO collector - assigned when collector scans QR)
        const unit = await tx.unit.create({
            data: {
                ...
                collectorId: null, // Assigned when collector scans QR
            }
        });
